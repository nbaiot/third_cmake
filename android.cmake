...
elseif (X86)
    set(NDK_CC ${NDK_TOOLCHAIN}/bin/i686-linux-androideabi${ANDROID_PLATFORM_LEVEL}-clang${CMAKE_EXECUTABLE_SUFFIX})
    set(NDK_CXX ${NDK_TOOLCHAIN}/bin/i686-linux-androideabi${ANDROID_PLATFORM_LEVEL}-clang++${CMAKE_EXECUTABLE_SUFFIX})
else (X86_64)
