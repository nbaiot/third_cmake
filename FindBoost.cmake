...
if (APPLE)
    set(BOOST_INSTALL_DIR /usr/local/)
else ()
...
if (NOT EXISTS ${BOOST_INSTALL_DIR} OR (NOT EXISTS ${BOOST_INCLUDE_DIR}) OR (NOT EXISTS ${BOOST_LIBRARY_DIR}))
...
if (${BOOST_INSTALL})
    foreach (SUBLIB ${Boost_FIND_COMPONENTS})
        ...
        set_property(TARGET ${SUB_TARGET} PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${BOOST_INCLUDE_DIR})
    endforeach ()
