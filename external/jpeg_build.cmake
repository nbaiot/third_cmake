...
set(JPEG_INSTALL_DIR ${THIRD_PARTY_INSTALL_PATH}/jpeg-turbo)
...
set(JPEG_URL "http://localhost:8888/libjpeg-turbo-2.0.4.tar.gz")
...
ExternalProject_Add(
        ...
        CMAKE_CACHE_ARGS -DCMAKE_INSTALL_PREFIX:PATH=${JPEG_INSTALL_DIR}
...
set(JPEG_LIBRARIE "${JPEG_INSTALL_DIR}/lib/libjpeg-turbo${LIB_SUFFIX}" CACHE FILEPATH "JPEG_LIBRARIE" FORCE)
